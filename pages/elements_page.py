...
class TextBoxPage(BasePage):
    ...
    def check_filled_form(self):
        ...
        current_address = self.element_is_present(self.locators.CURRENT_ADDRESS).text.split(':')[1]
        permanent_address = self.element_is_present(self.locators.PERMANENT_ADDRESS).text.split(':')[1]
        return full_name, email, current_address, permanent_address
